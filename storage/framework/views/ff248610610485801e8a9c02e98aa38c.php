...
<div class="max-w-5xl p-8 mx-auto rounded-lg shadow" style="background-color: rgba(75, 85, 99, 0.60);">
    <div class="flex items-center justify-between mt-4 mb-6 text-sm">
            ...
            <div class="flex ml-auto space-x-2">
                <a href="<?php echo e(route('inventory.categories.create')); ?>" class="px-3 py-1 text-white bg-gray-600 rounded hover:bg-gray-700">
                    ➕ Add Category
                </a>
...
<?php echo $__env->make('layouts.inventory', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Erp-system\erp-system\resources\views/inventory/categories/index.blade.php ENDPATH**/ ?>