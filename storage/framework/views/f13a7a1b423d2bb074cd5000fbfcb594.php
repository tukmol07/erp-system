            ...
            <div class="flex items-center space-x-6">
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->role === 'HR'): ?>
                        ...
                        <a href="<?php echo e(route('hr.hr.notifications')); ?>" class="relative flex items-center">
                            <span class="text-lg">🔔</span>
                            <?php if(auth()->user()->unreadNotifications->count()): ?>
                                <span class="absolute top-0 right-0 flex items-center justify-center inline-block w-4 h-4 text-xs font-bold text-white bg-red-500 rounded-full">
...
<?php /**PATH C:\Erp-system\erp-system\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>