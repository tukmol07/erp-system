...
<div class="container max-w-4xl p-6 mx-auto mt-6 bg-white rounded shadow">
    ...
    <div class="mb-4">
        <a href="<?php echo e(route('hr.dashboard')); ?>" class="inline-block px-4 py-2 text-white bg-gray-600 rounded hover:bg-gray-700">
    ...
    <form action="<?php echo e(route('hr.payroll.store')); ?>" method="POST">
        ...
        <div class="flex justify-end gap-4 mt-6">
            <a href="<?php echo e(route('hr.payroll.index')); ?>" class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400">Cancel</a>
