...
<div class="form-container">
    ...
    <form action="<?php echo e(route('hr.employment.store')); ?>" method="POST">
        ...
        <a href="<?php echo e(route('hr.dashboard')); ?>" class="inline-block px-6 py-2 mb-4 text-sm font-semibold text-black transition duration-300 ease-in-out bg-gray-600 rounded-md hover:bg-gray-700"><-Back</a>
