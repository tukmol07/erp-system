...
<div class="form-container">
    ...
    <form action="<?php echo e(route('hr.employment.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <a href="<?php echo e(route('hr.dashboard')); ?>" class="inline-block px-6 py-2 mb-4 text-sm font-semibold text-white transition duration-300 ease-in-out bg-gray-600 rounded-md hover:bg-gray-700">Cancel</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Erp-system\erp-system\resources\views/hr/employment/create.blade.php ENDPATH**/ ?>