...
<div class="flex items-center justify-between mb-6">
    ...
    <div class="flex space-x-4">
        <a href="{{ route('inventory.items.create') }}" class="px-2 py-1 text-white bg-indigo-600 rounded hover:bg-indigo-700">
            ➕ Add New Item
        </a>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr @if($item->quantity <= $item->min_stock) class="border-t hover:bg-gray-50" @endif>
                    ...
                    <td class="flex p-3 space-x-2">
                        <a href="{{ route('inventory.items.edit', $item->id) }}" class="px-3 py-1 text-white bg-indigo-600 rounded hover:bg-indigo-700">Edit</a>
