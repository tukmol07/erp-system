<form method="GET" action="{{ route('inventory.items.index') }}" class="flex flex-wrap gap-4 mb-4">
    ...
    <select name="category" class="inline-block p-2 border rounded">
    ...
    <select name="filter" class="inline-block p-2 border rounded">
    ...
    <button type="submit" class="inline-block p-2 text-white bg-indigo-600 rounded hover:bg-indigo-700">Filter</button>
</form>
